        ...
        for j in range(self.traing_step):
            ...
            for i in range(self.num_rain):
                ...
                while True:
                    ...
                    observation_, reward, done, info, _ = self.env.step(np.array([action]),self.rainData[i])
    ...
    def test(self,test_num):
        ...
        for i in range(test_num):
            ...
            while True:
                ...
                observation_, reward, done, info, flooding = self.env.step(np.array([action]),self.testRainData[i])
